...
- **Reference (Cột tham chiếu):** Phải tuân thủ cấu trúc: `[VỊ TRÍ THAM CHIẾU] – [TRÍCH DẪN QUY TẮC NGẮN GỌN (tối đa 1-2 câu)]`. Bắt lỗi ngay nếu chỉ ghi vị trí mà thiếu trích dẫn nội dung quy tắc, hoặc nếu dùng số dòng (Ví dụ sai: "Dòng 15", "Mục 2").
