...
data = [
    ...
    ("US06-TC-068","SC-52",'Mục "Thêm mới" P37-P40 – "thay đổi chỉ trong scope Biểu phí"',FEAT,"Toàn vẹn dữ liệu",
     "Sửa Code phí tại Biểu phí: Code phí gốc tại Danh mục SPDV không ảnh hưởng","Data Integrity","High",
     ...
     "(i) Nghiệp vụ/Logic: CP001 tại BP-030 có Giá trị = 50000. CP001 tại Danh mục SPDV vẫn = 20000.\n(ii) UI: 2 màn hình hiển thị giá trị khác nhau (scope Biểu phí vs gốc).",""),
