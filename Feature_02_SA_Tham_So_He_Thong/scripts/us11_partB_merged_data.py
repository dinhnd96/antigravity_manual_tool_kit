...
QA_DATA = [
    ...
    ("US11-QA-01.11",
     "Bảng mô tả trường 'Kỳ' - Cột 'Ràng buộc'",
     "Tài liệu ghi: 'Kỳ phải có giá trị bằng dòng liền trước...' nhưng không mô tả rõ ràng buộc được enforce thế nào khi thêm dòng mới. FE có tự động điền giá trị Kỳ hay người dùng phải tự nhập?",
     "Nghiệp vụ",
     "Đề xuất: BA bổ sung đầy đủ ràng buộc trường Kỳ khi giá trị bằng dòng liền trước.",
     "VA"),
]
