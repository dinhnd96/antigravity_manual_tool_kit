...
QA_DATA_2 = [
    ...
    ("US39-QA-02.4",
     "Mục \"Yêu cầu nghiệp vụ\", đoạn văn P5-P9 (bậc thang THKV)",
    ...
    ("US39-QA-03.3",
     "Mục \"Yêu cầu nghiệp vụ\", đoạn văn P10: \"Mỗi CTƯĐ có Mã hạch toán riêng, khai báo từ khi khởi tạo tài khoản LD\"",
    ...
    ("US39-QA-03.7",
     "Bảng diễn giải TABLE 0 – Bước 0 (Đồng bộ dữ liệu T-1)",
    ...
    ("US39-QA-03.8",
     "Bảng diễn giải TABLE 0 – Nhiều bước không có số thứ tự (STT)",
    ...
    ("US39-QA-04.3",
     "Mục \"Yêu cầu nghiệp vụ\", đoạn văn P14-P15: \"Khai báo 01 Biểu phí dành riêng cho các CTƯĐ cho vay và gắn các Code phí nêu trên vào Biểu phí này\"",
