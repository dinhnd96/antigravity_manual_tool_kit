...
tc_data = [
    [
        "SA08-NEG-001", "BR_01", "SA.08", "SA08", "Sửa Tham số mặc định", 
        ...
        "1. Người dùng đã đăng nhập hệ thống.\n2. Được phân quyền Quản lý tham số.\n3. Đang ở màn hình Sửa tham số mặc định.", 
        ...
        "SA08-FMT-REQ", "Gộp các trường hợp: Bỏ trống trường Thời gian time-out, bỏ trống trường Số lần tối đa đăng nhập sai"
    ],
    [
        "SA08-NEG-002", "BR_01", "SA.08", "SA08", "Sửa Tham số mặc định", 
    ...
    [
        "SA08-HPY-001", "BR_02", "SA.08", "SA08", "Sửa Tham số mặc định", 
        "Kiểm tra hệ thống hủy bỏ thao tác cập nhật và không lưu dữ liệu khi chọn nút Đóng trên màn hình Sửa", 
        "Happy", "Regression", "P2", 
        "1. Người dùng đã đăng nhập hệ thống.\n2. Được phân quyền quản lý tham số.\n3. Đang mở màn hình Sửa tham số mặc định cho một bản ghi bất kỳ.", 
    ...
    [
        "SA08-CALC-001", "BR_03", "SA.08", "SA08", "Sửa Tham số mặc định", 
        "Kiểm chức năng cập nhật Thời gian time-out và tự động đăng xuất người dùng khi hết phiên", 
        "Calculation", "Smoke", "P1", 
        "1. Có tài khoản test.\n2. Người dùng được phân quyền.\n3. Đang ở màn hình Quản lý tham số.", 
    ...
    [
        "SA08-CALC-002", "BR_03", "SA.08", "SA08", "Sửa Tham số mặc định", 
    ...
    [
        "SA08-UI-VIEW-001", "UI-FUNC.01", "SA.08", "SA08", "Xem Tham số mặc định", 
        "Kiểm tra giao diện và luồng hiển thị readonly dữ liệu của bản ghi chi tiết trên màn hình Xem tham số", 
        "Happy", "Regression", "P2", 
        "1. Người dùng đã đăng nhập hệ thống.\n2. Được phân quyền.\n3. Đang ở màn hình Danh sách tham số mặc định.", 
        "1. Tại lưới danh sách, nhấn icon / nút Xét tại bản ghi tham số cần kiểm tra. \n2. Kiểm tra giao diện popup Xem chi tiết. \n3. Nhấn nút Đóng.", 
    ...
    [
        "SA08-UI-EDIT-001", "UI-FUNC.02", "SA.08", "SA08", "Sửa Tham số mặc định", 
        "Kiểm tra giao diện và load hiển thị thông tin khởi tạo trên form form Sửa tham số", 
        "Happy", "Regression", "P2", 
        "1. Người dùng đã đăng nhập hệ thống.\n2. Được phân quyền.\n3. Đang ở màn hình Danh sách tham số mặc định.", 
        ...
        "SA08-ED-001", "ĐÃ COVER thao tác Lưu/Validate tại TC_ID=SA08-CALC-001 và TC_ID=SA08-NEG-001"
    ],
    [
        "SA08-E2E-001", "E2E", "SA.08", "SA08", "Sửa Tham số mặc định", 
    ...
    [
        "SA08-AUTH-001", "N/A", "SA.08", "SA08", "Sửa Tham số mặc định", 
        "Kiểm tra hệ thống từ chối truy cập và thực thi cập nhật khi sử dụng tài khoản không được phân quyền", 
        "Negative", "Regression", "P1", 
        "1. Có 1 tài khoản test hoàn toàn KHÔNG CÓ Quyền Quản lý tham số.", 
