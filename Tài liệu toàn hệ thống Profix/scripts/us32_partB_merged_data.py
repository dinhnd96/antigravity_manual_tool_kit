...
HM1_DATA = [
    ...
    (
        'US32-QA-01.7',
        'Mục "Dashboard theo Khối", đoạn "Danh sách các khách hàng có số lượng giao dịch thu phí nhiều nhất trong ngày hệ thống"',
    ...
    (
        'US32-QA-01.8',
        'Mục "Dashboard theo Chi nhánh", biểu đồ "Nợ phí và truy thu theo chi nhánh", đoạn "Số tiền nợ phí [...] từ đầu tháng đến ngày hệ thống"',
...
HM2_DATA = [
    ...
    (
        'US32-QA-02.2',
        'Mục "Dashboard theo Chi nhánh", đoạn "Mặc định top 5. Người dùng có thể tùy chỉnh n = 5/10/15"',
    ...
    (
        'US32-QA-02.4',
        'Mục "Dashboard theo Sản phẩm", biểu đồ "Doanh thu phí theo SPDV", đoạn "Cho phép chọn cấp SPDV (tối đa theo tham số product_level)"',
    ...
    (
        'US32-QA-02.6',
        'Mục "Yêu cầu nghiệp vụ" — Tài liệu không mô tả hành vi khi chưa có dữ liệu giao dịch trong tháng (GAP)',
    ...
    (
        'US32-QA-02.7',
        'Mục "Yêu cầu nghiệp vụ" — Tài liệu không mô tả cơ chế cập nhật/làm mới dữ liệu Dashboard (GAP)',
...
HM3_DATA = [
    (
        'US32-QA-03.1',
        'Mục "Yêu cầu nghiệp vụ", đoạn "tổng doanh thu phí giao dịch đã thu [...] không tính các giao dịch đã bị reverse"',
    ...
    (
        'US32-QA-03.4',
        'Mục "Dashboard theo Chi nhánh" + "Dashboard theo Sản phẩm" — Tài liệu không mô tả hành vi khi CN/SPDV ngừng hoạt động giữa tháng (GAP)',
    ...
    (
        'US32-QA-03.5',
        'Mục "Dashboard theo Chi nhánh", biểu đồ "Nợ phí và truy thu", đoạn "Số tiền đã truy thu thành công" — Tài liệu không định nghĩa sự kiện trigger (GAP)',
...
HM4_DATA = [
    (
        'US32-QA-04.1',
        'Mockup image1, biểu đồ "Doanh thu phí dịch vụ theo chi nhánh", đoạn "Phần trung tâm: Tổng doanh thu phí toàn ngân hàng trong tháng"',
    ...
    (
        'US32-QA-04.2',
        'Mockup image2 + image3 — Hiển thị vùng "Tính năng đang phát triển" nhưng tài liệu text không mô tả nội dung (GAP)',
    ...
    (
        'US32-QA-04.3',
        'Mục "Dashboard theo Sản phẩm", biểu đồ "Số giao dịch thu phí theo sản phẩm" — Tài liệu không mô tả trục X/Y (GAP so với biểu đồ "Doanh thu phí theo SPDV")',
    ...
    (
        'US32-QA-04.4',
        'Mockup image3, mục "Dashboard theo Khối" — Mockup hiển thị 2 UI component khác nhau cho chức năng "Chọn Khối"',
    ...
    (
        'US32-QA-04.6',
        'Mục "Dashboard theo Khối", bảng "Danh sách KH giao dịch nhiều nhất", cột "Doanh thu" — đoạn "Tổng doanh thu phí tương ứng với các giao dịch đã thống kê"',
    ...
    (
        'US32-QA-04.7',
        'Mục "Yêu cầu nghiệp vụ", Phân vùng chỉ số tổng quan, đoạn "Phần trăm thay đổi [...] Nếu kết quả >=100% thì hiển thị màu xanh"',
    ...
    (
        'US32-QA-04.8',
        'Mục "Dashboard theo Khối", biểu đồ "Nợ phí và truy thu", đoạn "Trục X: Khối KHCN, Khối KHDNL, Khối KHDN" (so sánh vs Mockup image3)',
