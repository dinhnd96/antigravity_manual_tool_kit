...
QA_DATA = [
    ...
    ("US39-QA-01.2",
     "Mục \"Yêu cầu nghiệp vụ\" – *\"Với các khách hàng không tham gia Chương trình ưu đãi, phí trả nợ trước hạn sẽ áp dụng theo mức phí chung quy định tại Biểu phí dịch vụ trong từng thời kỳ\"*",
    ...
    ("US39-QA-01.4",
     "Mục \"Yêu cầu nghiệp vụ\" – *\"Nếu THKV>36M hoặc THKV > 70% thời hạn hợp đồng: Miễn phí\"*",
    ...
    ("US39-QA-01.5",
     "Mục \"Yêu cầu nghiệp vụ\" – *\"hệ thống T24 hiển thị thông tin phí và cho phép người dùng sửa số tiền phí cần thu, T24 kiểm tra số tiền phí người dùng nhập vào có nằm ngoài khoảng [...]\"*",
    ...
    ("US39-QA-01.7",
     "Mục \"Yêu cầu nghiệp vụ\", danh sách trường ETL – *\"Phần trăm thời hạn hợp đồng (dùng để khai báo vào điều kiện 'Thời gian vay thực tế' của Code phí)\"*",
